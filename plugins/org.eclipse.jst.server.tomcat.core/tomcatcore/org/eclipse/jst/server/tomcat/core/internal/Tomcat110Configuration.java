...
/**
 * Tomcat v11.0 server configuration.
 */
public class Tomcat110Configuration extends TomcatConfiguration {
...
//	protected String policyFile;
	...
	/**
	 * Tomcat110Configuration constructor.
	 * 
	 * @param path a path
	 */
	public Tomcat110Configuration(IFolder path) {
		super(path);
	}
...
//			monitor.worked(1);
			...
			TomcatPlugin.log(e);
			Trace.trace(Trace.WARNING, "Could not load Tomcat v11.0 configuration from " + path.toOSString() + ": " + e.getMessage());
...
//			monitor.worked(200);
			...
			TomcatPlugin.log(e);
			Trace.trace(Trace.WARNING, "Could not reload Tomcat v11.0 configuration from: " + folder.getFullPath() + ": " + e.getMessage());
...
//			monitor.worked(1);
			...
			Trace.trace(Trace.SEVERE, "Could not save Tomcat v11.0 configuration to " + path, e);
...
//				file.create(in, true, ProgressUtil.getSubMonitorFor(monitor, 200));
			...
			Trace.trace(Trace.SEVERE, "Could not save Tomcat v11.0 configuration to " + folder.toString(), e);
			throw new CoreException(new Status(IStatus.ERROR, TomcatPlugin.PLUGIN_ID, 0, NLS.bind(Messages.errorCouldNotSaveConfiguration, new String[] {e.getLocalizedMessage()}), e));
		}
	}
