/**********************************************************************
 * Copyright (c) 2020, 2024 SAS Institute and others.
...
public class Tomcat110PublishModuleVisitor extends TomcatPublishModuleVisitor {

	/**
	 * Instantiate a new Tomcat110PublishModuleVisitor
	 * 
	 ...
	 */
	Tomcat110PublishModuleVisitor(IPath baseDir, String tomcatVersion, ServerInstance serverInstance, String sharedLoader, boolean enableMetaInfResources) {
